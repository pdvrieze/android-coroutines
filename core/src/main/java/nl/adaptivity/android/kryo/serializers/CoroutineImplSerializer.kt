...
internal class CoroutineImplSerializer(kryo: Kryo, type: Class<*>): FieldSerializer<Any>(kryo, type, null, FieldSerializerConfig().apply { isIgnoreSyntheticFields=false }) {
